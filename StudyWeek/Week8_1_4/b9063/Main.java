/*
🖥️ [기하: 직사각형과 삼각형] 9063번 문제: 대지
🖥️ https://www.acmicpc.net/problem/9063
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        int w = listx.get(listx.size() - 1) - listx.get(0);
        int h = listy.get(listy.size() - 1) - listy.get(0);
